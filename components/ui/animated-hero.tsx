            ...
            <div className="container mx-auto">
                <div className="flex gap-8 py-20 lg:py-40 items-center justify-center flex-col">
                    ...
                    <div className="flex flex-row gap-3">
                        <Button size="lg" className="gap-4 px-10 py-4 text-lg md:text-xl border-[#8BADA4] text-[#8BADA4] hover:bg-[#8BADA4]/10 hover:text-[#8BADA4]" variant="outline">
                            Fale Conosco <PhoneCall className="w-5 h-5 md:w-6 md:h-6" />
                        </Button>
                        <Button size="lg" className="gap-4 px-10 py-4 text-lg md:text-xl bg-[#8BADA4] hover:bg-[#7A9A8D] text-white">
