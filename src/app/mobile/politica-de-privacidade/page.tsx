...
export default function PoliticaDePrivacidadeMobilePage() {
    return (
        <div className="min-h-screen bg-[#3E5A54] text-white flex flex-col">
            ...
            <div className="flex-1 max-w-xl mx-auto py-10 px-4">
                ...
                <h2 className="text-lg font-semibold mt-6 mb-2">3. Segurança</h2>
                ...
                <h2 className="text-lg font-semibold mt-6 mb-2">5. Alterações nesta Política</h2>
                <p className="mb-4 opacity-90">Podemos atualizar esta política periodicamente. Recomendamos que você a revise regularmente.</p>
                <p className="mt-6 opacity-70">Em caso de dúvidas, entre em contato: <a href="mailto:contato@yallah.com" className="underline text-white">contato@yallah.com</a></p>
            </div>
            <Footer />
        </div>
    );
